...
export const ENGINE_DECLARATION_AWARENESS: readonly EngineDeclarationAwarenessEntry[] = [
  ...
  { construct: 'Specification.keyed_collections', status: 'emitted', note: 'Persistence-oriented generated programs emit keyed_collections for engine-owned upsert dedupe. Parity-confirmed v5.6.0 #993: keyed/merge MAppend now infers from_arg as the ELEMENT type, so the foundry-emitted keyed_collections upsert stays deterministic with no emission change.' },
