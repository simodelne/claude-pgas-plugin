...
export const ENGINE_DECLARATION_AWARENESS: readonly EngineDeclarationAwarenessEntry[] = [
  ...
  { construct: 'Feature.reference_data', status: 'available_unused', note: 'v5.2.0 #980 Feature includes reference_data at node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:141; current generated programs do not need a reference_data block, but the foundry may emit it when a real domain vocabulary, denylist pattern set, or keyed rule set would otherwise be generated as TS.' },
  ...
  { construct: 'Predicate.Always', status: 'available_unused', note: 'v4.10.0 #836 adds Always as the 23rd PredicateKind for explicit unconditional predicates; foundry already uses derived_paths when.always and has no guard/precondition emitter that needs a Predicate.Always leaf yet. Anchor node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:104.' },
  { construct: 'Predicate.StringLengthLessThan', status: 'available_unused', note: 'v5.2.0 adds StringLengthLessThan to PredicateKind with max as the exclusive string length upper bound; no generated descriptor currently needs this predicate. Anchors node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:104 and max docs at 786-794.' },
  { construct: 'Predicate.FieldMatchesNoneOfPatternSet', status: 'available_unused', note: 'v5.2.0 adds FieldMatchesNoneOfPatternSet to PredicateKind for source_path-backed pattern-set checks, intended to pair with reference_data denylist pattern sets when emitted; current generator audit found no hardcoded generated-program TS denylist to migrate. Anchor node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:104.' },
  ...
  { construct: 'Predicate.FieldNe', status: 'held', note: 'Not present in the v5.6.0 PredicateKind type surface; do not emit unless the engine adds it.' },
  { construct: 'Predicate.Not', status: 'held', note: 'Not present in the v5.6.0 PredicateKind type surface; use shipped combinators only.' },
  ...
  { construct: 'derived_paths.max_of', status: 'adopt_backlog', note: 'v4.10.0 #836 SetMaxOf computes the maximum numeric field across a collection; foundry does not yet have a max-report or max-threshold descriptor. Anchor node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:1470 and raw YAML set kind at 2805.' },
  { construct: 'derived_paths.join_from', status: 'adopt_backlog', note: 'v4.10.0 #836 exposes join_from-style membership filtering as items_where_field_in_collection: keep source rows whose field appears in a second collection. Phase C uses it narrowly for refused/skipped report audit filtering; broader join descriptor sugar remains backlog. Anchors node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:1470 and source_path/source_item_path at 1543-1555.' },
  { construct: 'collections.invariant_require_on', status: 'available_unused', note: 'v4.10.0 #836 PGAS-L collection sugar can express per-record invariants with collection require: and collection aggregate item_requires/on-style invariants; foundry still emits schema_invariants directly. Anchors node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:2932-2933 and 3019-3020.' },
