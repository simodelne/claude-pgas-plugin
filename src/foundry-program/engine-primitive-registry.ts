...
export const ENGINE_DECLARATION_AWARENESS: readonly EngineDeclarationAwarenessEntry[] = [
  ...
  { construct: 'Specification.view', status: 'emitted', note: 'Standalone generated programs serialize top-level view: sidecars consumed by loadProgramByConvention; existing-repo targets keep the residual ProgramEntry.viewProfile registration path. Anchors are node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:5261-5270 and ProgramEntry.viewProfile/projectionBuilderMigration at 5699-5729.' },
  ...
  { construct: 'Predicate.FieldNe', status: 'held', note: 'Not present in the v5.3.1 PredicateKind type surface; do not emit unless the engine adds it.' },
  { construct: 'Predicate.Not', status: 'held', note: 'Not present in the v5.3.1 PredicateKind type surface; use shipped combinators only.' },
