...
export const ENGINE_DECLARATION_AWARENESS: readonly EngineDeclarationAwarenessEntry[] = [
  ...
  { construct: 'Specification.import', status: 'available_unused', note: 'v4.12 #917 file loaders and loadProgramByConvention resolve import: fragments and force strict blueprint validation on imported specs; generated programs still emit a single specs.yml. Anchors node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:4438-4444 and plugin.mjs import diagnostics.' },
  { construct: 'SpecWiringValidationOptions.blueprint', status: 'emitted', note: 'v4.12 #917 exposes blueprint modes off|warn|strict; foundry convention validation uses blueprint:off for temp snippets while generated runtime helpers leave the engine default warn unless import: requires strict. Anchor node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:4438-4444.' },
  ...
  { construct: 'Specification.collection', status: 'available_unused', note: 'v4.12 PGAS-L collection blocks desugar to shipped collection primitives; the foundry emits scattered primitives directly rather than PGAS-L collection blocks. Anchor node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:2979-2990.' },
  { construct: 'PGAS-L.collection', status: 'available_unused', note: 'v4.12 PGAS-L introduces collection <path> { ... } authoring sugar; generated specs continue to emit explicit keyed_collections, schema_invariants, derived_paths, and collection_finalizers surfaces. Anchor node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:2979-2990.' },
