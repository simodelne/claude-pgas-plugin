...
export const ENGINE_DECLARATION_AWARENESS: readonly EngineDeclarationAwarenessEntry[] = [
  ...
  { construct: 'Predicate.FieldNe', status: 'held', note: 'Not present in the v5.2.0 PredicateKind type surface; do not emit unless the engine adds it.' },
  { construct: 'Predicate.Not', status: 'held', note: 'Not present in the v5.2.0 PredicateKind type surface; use shipped combinators only.' },
