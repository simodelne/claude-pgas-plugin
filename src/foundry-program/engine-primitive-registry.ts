...
export const ENGINE_DECLARATION_AWARENESS: readonly EngineDeclarationAwarenessEntry[] = [
  ...
  { construct: 'Specification.view', status: 'emitted', note: 'Phase B builds ViewSection[] for existing-repo typed result/read paths and emits them through ProgramEntry.viewProfile on generated registrations; generated specs.yml does not serialize top-level view: because the loader takes runtime viewProfile and does not accept the YAML block shape. In-spec YAML view: is deferred for #915/#917 blueprint compiler/loader adoption; anchors are node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:5261-5270 and ProgramEntry.viewProfile/projectionBuilderMigration at 5699-5729.' },
  { construct: 'Specification.render', status: 'emitted', note: 'Phase C builds RenderProfile declarations for PDF-report deliverable shape and emits them through ProgramEntry.renderProfile on generated registrations; generated specs.yml does not serialize top-level render: because render is render-tier, beside the engine Specification. Public anchors are node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:5310-5508 and ProgramEntry.renderProfile at 5743-5755.' },
  ...
  { construct: 'Specification.policies', status: 'adopt_backlog', note: 'Phase E backlog (blueprint block 11): declarative policies are acknowledged from public policy interfaces RetryBudget/RoundBudget/Query/DenialTracking/ContentScan/Risk/ProgramQuery in node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:3212-3366, node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:4768-4801, and node_modules/@simodelne/pgas-server/dist-bundle/_shared-types.d.ts:5520-5523; Phase B emits no policies block.' },
